...
window.onload = function() {
	//header
            ...
            footerPlaceholder.innerHTML = '<footer class="footer-area">' +
                ...
                '</span>' +
                '<a href="#"><span class="__cf_email__" data-cfemail="85ccebe3eac5e6eaebf6f1e0f7abe6eae8">info@Primecost-qs.com</span></a>' +
                '</li>' +
                '</ul>' +
                '</div>' +
                '</div>' +
	...
	function basicmap() {
		...
		var marker = new google.maps.Marker({
			...
			title: 'Karen Professional Centre, MPC9+V27, Karen Rd, Nairobi'
		});
	}
